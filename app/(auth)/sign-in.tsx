...
export default function SignInScreen() {
  ...
  const [verificationCodeRequested, setVerificationCodeRequested] =
    useState(false);
  ...
  const requestEmailVerificationCode = useCallback(async () => {
    ...
    if (!emailCodeFactor) {
      setFlowError(
        "Email verification is not available for this account. Try another sign-in method.",
      );
      return false;
    }
  ...
  useEffect(() => {
    if (!signIn || !verificationRequired) {
  ...
  const handleSubmit = async () => {
    ...
    setFlowError(
      "We need one more step to sign you in, but this app only supports email verification right now.",
    );
  };
  ...
  const handleVerify = async () => {
    ...
    setFlowError(
      "That code was accepted, but sign-in still needs another step.",
    );
  };
      ...
      >
        <View className="auth-form">
          ...
          <View className="auth-field">
            ...
            {hasServerCodeError ? (
              <Text className="auth-error">{hasServerCodeError}</Text>
            ) : null}
          </View>
    ...
    >
      <View className="auth-form">
        ...
        <View className="auth-field">
          ...
          {serverEmailError ? (
            <Text className="auth-error">{serverEmailError}</Text>
          ) : null}
        </View>
        ...
        <View className="auth-field">
          ...
          {serverPasswordError ? (
            <Text className="auth-error">{serverPasswordError}</Text>
          ) : null}
        </View>
